  ...
  return (
    <main className="min-h-screen bg-black text-white p-25 font-sans">
      ...
      <ul className="mt-3 font-mono text-pink-300">
        ...
        <li>
          <Link href="./week-6" className="hover:text-pink-600 hover:underline">Week 6 Assignment</Link>
        </li>
        <li>
          <Link href="./week-7" className="hover:text-pink-600 hover:underline">Week 7 Assignment</Link>
        </li>
        <li>
          <Link href="./week-8" className="hover:text-pink-600 hover:underline">Week 8 Assignment</Link>
        </li>
        <li>
          <Link href="./week-9" className="hover:text-pink-600 hover:underline">Week 9 Assignment</Link>
        </li>
        <li>
          <Link href="./week-10" className="hover:text-pink-600 hover:underline">Week 10 Assignment</Link>
        </li>
      </ul>
    </main>
  );
